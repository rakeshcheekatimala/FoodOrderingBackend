        ...
        return new ResponseEntity<CouponDetailsResponse>(couponDetailsResponse , HttpStatus.OK);
         ...
         public  ResponseEntity<List<OrderList>> getOrderEntity(@RequestHeader("access-token") String accessToken) throws AuthorizationFailedException {
          ...
          for(OrdersEntity  order :orders) {
             ...
             System.out.println("orders"+orderItemEntity);
         ...
         public ResponseEntity<SaveOrderResponse> saveOrder(@RequestHeader("access-token")String access_token, SaveOrderRequest saveOrderRequest) throws AuthorizationFailedException, CouponNotFoundException, AddressNotFoundException, PaymentMethodNotFoundException, RestaurantNotFoundException {
             ...
             if( saveOrderRequest.getCouponId() != null) {
                 ...
                 couponEntity = couponBusinessService.getCouponByUUID(saveOrderRequest.getCouponId());
                 if (couponEntity == null) {
             ...
             if( saveOrderRequest.getAddressId() != null)
              ...
              PaymentEntity paymentEntity=null;
               ...
               OrdersEntity ordersEntity= new OrdersEntity();
                 ...
                 orderItemEntity= orderBusinessService.saveOrder(orderItemEntity);

                 SaveOrderResponse saveOrderResponse=new SaveOrderResponse().id(orderItemEntity.getOrders().getUuid()).status("ORDER SUCCESSFULLY PLACED");
